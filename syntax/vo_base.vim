...
" Dark background {{{2
	...
	" color for user text (wrapping)
	hi UT1 guifg=cyan	ctermfg=cyan
	hi UT2 guifg=cyan	ctermfg=cyan
	hi UT3 guifg=cyan	ctermfg=cyan
	hi UT4 guifg=cyan	ctermfg=cyan
	hi UT5 guifg=cyan	ctermfg=cyan
	hi UT6 guifg=cyan	ctermfg=cyan
	hi UT7 guifg=cyan	ctermfg=cyan
	hi UT8 guifg=cyan	ctermfg=cyan
	hi UT9 guifg=cyan	ctermfg=cyan
